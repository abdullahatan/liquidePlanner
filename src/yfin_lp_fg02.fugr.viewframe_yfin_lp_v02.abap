*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_YFIN_LP_V02
*   generation date: 07.04.2022 at 13:34:07
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_YFIN_LP_V02         .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_YFIN_LP_V02'
         EXPORTING
              FCODE          = READ
...
EXTRACT = YFIN_LP_V02_EXTRACT
TOTAL = YFIN_LP_V02_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_YFIN_LP_V02'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_YFIN_LP_V02-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = YFIN_LP_V02_EXTRACT
TOTAL = YFIN_LP_V02_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_YFIN_LP_V02-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_YFIN_LP_V02'
...
TOTAL = YFIN_LP_V02_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_YFIN_LP_V02-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_YFIN_LP_V02-UPD_FLAG NE SPACE.
