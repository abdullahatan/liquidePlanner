...
*"----------------------------------------------------------------------
  ...
  FREE: _fm01dat.
  _fm01dat = VALUE #( iv_tunit = iv_tunit iv_strname_tab1 = iv_strname_tab1 iv_strname_tab2 = iv_strname_tab2 t_alvdat_tab1 = t_alvdat_tab1[] t_alvdat_tab2 = t_alvdat_tab2[] ).
  CALL SCREEN 9001 STARTING AT 20 8 ENDING AT 162 34.
  ev_action = _fm01dat-ev_action.
